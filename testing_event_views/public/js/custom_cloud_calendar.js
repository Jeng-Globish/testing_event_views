...
frappe.views.Calendar = class Calendar {
    ...
    setup_options(defaults) {
        ...
        this.cal_options = {
            ...
            slotMinTime: this.slotMinTime, // for FullCalendar v4+ TimeGrid View
            slotMaxTime: this.slotMaxTime, // for FullCalendar v4+ TimeGrid View
            minTime: this.slotMinTime, // for FullCalendar v3 Agenda View
            maxTime: this.slotMaxTime, // for FullCalendar v3 Agenda View
